...
import com.trabalhodevweb.crm.infra.security.TokenService;
...
import com.trabalhodevweb.crm.model.dto.LoginResponseDTO;
...
public class AuthController {
    ...
    public ResponseEntity register(@RequestBody @Validated RegisterDTO data){
        ...
        Usuario novoUsuario = new Usuario(data.login(), data.nome(), senhaEncriptada, data.email(), Cargo.ADMINISTRADOR);
